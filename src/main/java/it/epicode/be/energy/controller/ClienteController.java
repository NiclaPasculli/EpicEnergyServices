...
public class ClienteController {
	...
	@Operation(description = "creazione di un nuovo cliente")
	...
	@GetMapping(path = "/cliente/ordinaperragionasociale")
	...
	@GetMapping(path = "/cliente/ordinaperfatturato")
	...
	@GetMapping(path = "/cliente/perfatturato/{minimo}/{massimo}")
	@Operation(description = "cerca lista clienti per range di fatturato annuale")
	@PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
	public ResponseEntity<Page<Optional<Cliente>>> findByFatturatoAnnuale(@PathVariable BigDecimal minimo,
	...
	@GetMapping(path = "/cliente/perdatainserimento/{dataInserimento}")
	...
	@GetMapping(path = "/cliente/perultimocontatto/{dataUltimoContatto}")
	...
	@GetMapping(path = "/cliente/perragionesociale/{ragioneSociale}")
