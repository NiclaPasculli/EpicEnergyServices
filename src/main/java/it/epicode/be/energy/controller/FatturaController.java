...
public class FatturaController {
	...
	@GetMapping(path = "/fattura/perimporto/{minimo}/{massimo}")
	...
	@GetMapping(path = "/fattura/perstato/{statoFattura}")
	...
	@GetMapping(path = "/fattura/perdata/{data}")
	...
	@GetMapping(path = "/fattura/peranno/{anno}")
